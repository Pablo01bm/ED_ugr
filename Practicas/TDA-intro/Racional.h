...
/**
 *  @brief Funcion que devuelve valor real asociado a uno racional
 *  @retval devuelve el valor real
 *  
**/
double valorReal();
...
/**
 * @brief operador que sobrecarga /
 * @param racional a dividir con el objeto implicito
 * @retval devuelve el resultado de dividir el racional con el asociado
**/
Racional operator/(const Racional &r);
