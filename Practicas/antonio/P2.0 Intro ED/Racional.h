/**
  ...
  * @author Antonio Quirante Hernandez
  */
...
/**
  ...
  * @param r racional al dividir con el objeto implicito
  * @return devuelve el cociente del racional
  */
...
*/
 ...
 /**
  * @brief Convierte un racional en irreducible;
  * @return Valor del racional en forma irreducible;
  */
  Racional irreducible();

/**
  * @brief Devuelve el valor real de un racional;
  * @return Valor del racional en forma de double;
  */
  double ValorReal();
